...
keymap.set("n", "<A0>", ":BufferLineGoToBuffer 1<CR>", { noremap = true, silent = true })
keymap.set("n", "<A-1>", ":BufferLineGoToBuffer 2<CR>", { noremap = true, silent = true })
keymap.set("n", "<A-2>", ":BufferLineGoToBuffer 3<CR>", { noremap = true, silent = true })
